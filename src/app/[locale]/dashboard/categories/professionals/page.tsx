    ...
    <>
      <header className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-3xl font-bold">{t("professionalServices")}</h1>
            <p className="text-muted-foreground">{t("professionalServicesSubtitle")}</p>
          </div>
        </div>
      ...
      <div className="mt-6 space-y-4">
        <div className="flex items-center justify-between gap-4">
          <SearchInput
            placeholder={t("searchProfessionalCategories")}
            value={searchQuery}
